  ...
  async function initializeAndFetchData() {
    try {
      ...
      try {
        ...
        console.log('Creating sample fight cards:');
        ...
        const sampleFightCards: FightCard[] = [
          {
            id: 'sample-1',
            eventDate: tomorrowDate, // YYYY-MM-DD format
          ...
          {
            id: 'sample-2',
            eventDate: nextWeekDate, // YYYY-MM-DD format
        ...
        // Combine existing fight cards with sample data, but prioritize sample data for testing
